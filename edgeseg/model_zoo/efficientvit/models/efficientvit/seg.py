...
from edgeseg.model_zoo.efficientvit.models.efficientvit.backbone import EfficientViTBackbone, EfficientViTLargeBackbone
from edgeseg.model_zoo.efficientvit.models.nn import (
    ConvLayer,
    DAGBlock,
    FusedMBConv,
    IdentityLayer,
...
from edgeseg.model_zoo.efficientvit.models.utils import build_kwargs_from_config
...
def efficientvit_seg_b1(dataset: str, **kwargs) -> EfficientViTSeg:
    from edgeseg.model_zoo import Segformer
    
    from  .backbone import efficientvit_backbone_b1
...
def efficientvit_seg_b2(dataset: str, **kwargs) -> EfficientViTSeg:
    from .backbone import efficientvit_backbone_b2
